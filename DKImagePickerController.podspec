Pod::Spec.new do |s|
  ...
  s.homepage = 'https://github.com/squarespace/DKImagePickerController'
  s.license = { :type => 'MIT', :file => 'LICENSE' }
  s.author = { 'Bannings' => 'zhangao0086@gmail.com' }
  s.platform = :ios, '11.0'
  s.source = { :git => 'https://github.com/squarespace/DKImagePickerController.git', :tag => s.version.to_s }
